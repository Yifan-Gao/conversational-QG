...
class QueryDecoder(nn.Module):
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
        ...
        emb_size = self.embeddings.embedding_size
        self.attn = onmt.modules.QueryAttention(
    ...
    def forward(self, tgt, memory_bank, state, answer, memory_lengths=None,
                step=None):
        """
        Args:
        ...
        decoder_final, decoder_outputs, attns = self._run_forward_pass(
            tgt, memory_bank, state, answer, memory_lengths=memory_lengths)
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, answer,
                          memory_lengths=None):
        """
