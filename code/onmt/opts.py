...
def model_opts(parser):
    ...
    group.add_argument('-passage_enc_layers', type=int, default=2,
                       help='Number of layers in the passage encoder')
    group.add_argument('-qa_word_enc_layers', type=int, default=1,
                       help='Number of layers in the qa word encoder')
    group.add_argument('-qa_sent_enc_layers', type=int, default=1,
                       help='Number of layers in the qa sentence encoder')
    ...
    group.add_argument('-self_attention', type=int, default=1,
                       help='use self attention in encoder or not')
    ...
    group.add_argument('-coref_vocab', action="store_true",
                       help="""use coreference vocab to predict 
                       coref words if necessary""")
    group.add_argument('-lambda_coref_vocab', type=float, default=1,
                       help='lambda value for coref_vocab loss')
    group.add_argument('-coref_attn', action='store_true',
                       help="""use coreference attention mask to
                       calculate coreference attention loss""")
    group.add_argument('-lambda_coref_attn', type=float, default=1,
                       help="""lambda value for coref_attn loss""")
    group.add_argument('-coref_confscore', type=int, default=1,
                       help='use confidence score in coreference loss or not')
    group.add_argument('-flow', action='store_true',
                       help="""use flow loss to track conversation transitions""")
    group.add_argument('-lambda_flow', type=float, default=1,
                       help="""lambda value for flow loss""")
    group.add_argument('-flow_history', action='store_true',
                       help="""use flow history loss to track conversation transitions""")
    group.add_argument('-lambda_flow_history', type=float, default=1,
                       help="""lambda value for flow history loss""")
...
def preprocess_opts(parser):
    ...
    group.add_argument('-data_type',
                       choices=["concat", "query", "hier", "concat_sent"],
                       help="""concat: p <q> q <a> a <q> q <a> a <a> current_answer,
                               query: p <q> q <a> a <q> q <a> a <a>, current_answer,
                               hier: p, q..., a..., current_answer,
    ...
    # Options for CoQG task
    group = parser.add_argument_group('CoQG')
    group.add_argument('-src_nfeats', type=int, default=0,
                       help="Num. of src features")
    group.add_argument('-tgt_nfeats', type=int, default=0,
                       help="Num. of tgt features")
