...
class ReportMgr(ReportMgrBase):
    ...
    def _report_step(self, lr, step, train_stats=None, valid_stats=None):
        ...
        if train_stats is not None:
            ...
            self.log('Train xent corefvocab: %g' % train_stats.xent_corefvocab())
            self.log('Train xent corefattn: %g' % train_stats.xent_corefattn())
            self.log('Train flow loss: %g' % train_stats.flow_loss)
            self.log('Train flow history loss: %g' % train_stats.flow_history_loss)
        ...
        if valid_stats is not None:
            ...
            self.log('Validation xent corefvocab: %g' % valid_stats.xent_corefvocab())
            self.log('Validation xent corefattn: %g' % valid_stats.xent_corefattn())
            self.log('Validation flow loss: %g' % valid_stats.flow_loss)
            self.log('Validation flow history loss: %g' % valid_stats.flow_history_loss)
